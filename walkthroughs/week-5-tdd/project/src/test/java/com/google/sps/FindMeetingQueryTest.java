...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyoneIsConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  public void noMandatoryAttendees() {
    ...
    Collection<TimeRange> expected =
        ...
        TimeRange.fromStartDuration(TIME_0930AM, DURATION_30_MINUTES), TimeRange.fromStartEnd(TIME_1030AM, TimeRange.END_OF_DAY, true));

    Assert.assertEquals(expected, actual);
  }

  @Test
  public void noRoomOptionalAttendee() {
      Collection<Event> events = Arrays.asList(
  ...
  @Test
  public void everyoneIsConsideredEvenC() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
